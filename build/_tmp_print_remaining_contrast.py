...
for case in data['cases']:
    ...
    if fields:
        ...
        print(case['input'])
        print('EXP', expected['primary_intent'], expected['operations'], expected['information_state'], expected['constraints'], expected['risk'])
        print('ACT', actual['primary_intent'], actual['operations'], actual['information_state'], actual['constraints'], actual['risk'])
