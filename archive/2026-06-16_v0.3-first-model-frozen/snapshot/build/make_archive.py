...
ARCHIVE_ID = "2026-06-16_v0.3-first-model-frozen"
CREATED_FOR = (
    "FREEZE point: v0.3 gated-hybrid first model confirmed and frozen "
    "(intent 0.86 / e2e 0.82 / critical 0) for adoption in other projects + "
    "real-data accumulation. Includes the built collection pipeline and two "
    "confirmed-negative small-batch data rounds. Freeze record: "
    "docs/INTENT_MODEL_v0_3_FROZEN_2026-06-16.md"
)
